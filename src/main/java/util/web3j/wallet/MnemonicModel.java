...
public class MnemonicModel {
    ...
    public static class Crypto {
        ...
        @JsonTypeInfo(
                ...
                property="kdf")
        @JsonSubTypes({
                @JsonSubTypes.Type(value = Aes128CtrKdfParams.class, name = util.web3j.wallet.Wallet.AES_128_CTR),
                @JsonSubTypes.Type(value = ScryptKdfParams.class, name = util.web3j.wallet.Wallet.SCRYPT)
        })
