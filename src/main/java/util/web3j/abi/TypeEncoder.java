...
import util.web3j.abi.datatypes.Array;
import util.web3j.abi.datatypes.Bool;
import util.web3j.abi.datatypes.Bytes;
import util.web3j.abi.datatypes.BytesType;
import util.web3j.abi.datatypes.DynamicArray;
import util.web3j.abi.datatypes.DynamicBytes;
import util.web3j.abi.datatypes.NumericType;
import util.web3j.abi.datatypes.StaticArray;
...
import static util.web3j.abi.datatypes.Type.MAX_BIT_LENGTH;
import static util.web3j.abi.datatypes.Type.MAX_BYTE_LENGTH;
