 ...
 * This is so that we can pass around Typed {@link util.web3j.abi.datatypes.Array} types.</p>
 *
 ...
 */
public abstract class TypeReference<T extends util.web3j.abi.datatypes.Type> implements Comparable<TypeReference<T>> {
...
//    public static <T extends util.web3j.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
...
//    }
    ...
    public static abstract class StaticArrayTypeReference<T extends util.web3j.abi.datatypes.Type>
